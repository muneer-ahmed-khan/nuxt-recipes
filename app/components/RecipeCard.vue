...
<template>
  <div
    class="flex flex-col shadow rounded-md bg-[#f1f1f1] dark:bg-slate-800 dark:text-white"
  >
    <NuxtImg
      :src="recipe.image"
    ...
    <div class="flex flex-col py-6 px-4 flex-1">
      ...
      <div
        class="font-normal w-full bg-white/80 dark:bg-slate-900 flex gap-8 text-lg lg:text-xl mb-4 mt-auto"
      >
